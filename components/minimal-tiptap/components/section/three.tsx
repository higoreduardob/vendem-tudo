...
const COLORS: ColorPalette[] = [
  {
    ...
    colors: [
      ...
      { cssVar: 'var(--mt-accent-bold-blue)', label: 'Azul claro' },
      { cssVar: 'var(--mt-accent-bold-teal)', label: 'Esverdeado claro' },
      { cssVar: 'var(--mt-accent-bold-green)', label: 'Verde claro' },
      { cssVar: 'var(--mt-accent-bold-orange)', label: 'Laranja claro' },
      { cssVar: 'var(--mt-accent-bold-red)', label: 'Vermelho claro' },
      { cssVar: 'var(--mt-accent-bold-purple)', label: 'Roxo claro' },
    ],
  },
  {
    label: 'Palette 2',
    ...
    colors: [
      ...
      { cssVar: 'var(--mt-accent-teal)', label: 'Esverdeado' },
  ...
  },
  {
    ...
    colors: [
      { cssVar: 'hsl(var(--background))', label: 'White', darkLabel: 'Preto' },
      { cssVar: 'var(--mt-accent-blue-subtler)', label: 'Azul escurto' },
      { cssVar: 'var(--mt-accent-teal-subtler)', label: 'Esverdeado escuro' },
      { cssVar: 'var(--mt-accent-green-subtler)', label: 'Verde escuro' },
      { cssVar: 'var(--mt-accent-yellow-subtler)', label: 'Laranja escuro' },
      { cssVar: 'var(--mt-accent-red-subtler)', label: 'Vermelho escuro' },
      { cssVar: 'var(--mt-accent-purple-subtler)', label: 'Roxo escuro' },
    ],
  },
]
