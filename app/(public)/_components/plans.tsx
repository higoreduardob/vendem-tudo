...
export const Plans = () => {
  return (
    <Card className="overflow-hidden rounded-xl border-0 bg-purple-50">
      <CardHeader className="p-2">
        ...
        <div className="mt-4 flex items-baseline justify-center">
          <span className="text-3xl sm:text-5xl font-extrabold">R$149,90</span>
          <span className="ml-2 text-base sm:text-xl text-gray-400 line-through">
            R$199,90
          </span>
      ...
      <CardContent className="p-2 flex flex-col lg:flex-row gap-6 items-start">
        <div className="flex-1 h-full space-y-4 w-full">
        ...
        <div className="flex-1 text-white h-full space-y-4 w-full">
          <h3 className="text-sm font-semibold uppercase text-muted-foreground">
            Recursos ilimitados
          </h3>
