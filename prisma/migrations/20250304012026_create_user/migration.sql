-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMINISTRATOR', 'OWNER', 'MANAGER', 'EMPLOYEE');

-- CreateEnum
CREATE TYPE "StoreRole" AS ENUM ('FOOD');
...
CREATE TABLE "User" (
    ...
    "completedAccount" TIMESTAMP(3),
    "completedStore" TIMESTAMP(3),
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_selectedStore_fkey" FOREIGN KEY ("selectedStore") REFERENCES "Store"("id") ON DELETE SET NULL ON UPDATE CASCADE;
